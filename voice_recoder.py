...
def main():
    ...
    parser.add_argument("-f", "--file", type=str, default = "recording.wav", help="Output file name (default: recording.wav)")
    ...
    recorder = VoiceRecorder(filename=args.file, duration=args.duration, sample_rate=args.rate, play_after=args.play)
